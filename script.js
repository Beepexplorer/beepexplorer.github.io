...
function initializeApp() {
    ...
    riskBarElement.innerHTML = '<div id="riskIndicator" class="risk-indicator"></div>';
...
async function sendRiskAssessment() {
    ...
    try {
        // Sign in anonymously (or implement your preferred auth method)
